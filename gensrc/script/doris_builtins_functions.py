...
visible_functions = {
    ...
    "Geo": [
        ...
        [['ST_Contains'], 'BOOLEAN', ['STRING', 'STRING'], 'ALWAYS_NULLABLE'],
        [['ST_Intersects'], 'BOOLEAN', ['VARCHAR', 'VARCHAR'], 'ALWAYS_NULLABLE'],
        [['ST_Intersects'], 'BOOLEAN', ['STRING', 'STRING'], 'ALWAYS_NULLABLE'],
        [['ST_Within'], 'BOOLEAN', ['VARCHAR', 'VARCHAR'], 'ALWAYS_NULLABLE'],
        [['ST_PointN'], 'VARCHAR', ['VARCHAR','INT'], 'ALWAYS_NULLABLE'],
        [['ST_PointN'], 'VARCHAR', ['STRING','INT'], 'ALWAYS_NULLABLE'],
        [['ST_StartPoint'], 'VARCHAR', ['VARCHAR'], 'ALWAYS_NULLABLE'],
        [['ST_StartPoint'], 'VARCHAR', ['STRING'], 'ALWAYS_NULLABLE'],
        [['ST_EndPoint'], 'VARCHAR', ['VARCHAR'], 'ALWAYS_NULLABLE'],
        [['ST_EndPoint'], 'VARCHAR', ['STRING'], 'ALWAYS_NULLABLE'],
        [['ST_LineLocatePoint'], 'DOUBLE', ['VARCHAR','VARCHAR'], 'ALWAYS_NULLABLE'],
        [['ST_LineLocatePoint'], 'DOUBLE', ['STRING','STRING'], 'ALWAYS_NULLABLE'],
        [['ST_GeometryFromWkb', 'ST_GeomFromWkb'], 'VARCHAR', ['VARCHAR'], 'ALWAYS_NULLABLE'],
        [['ST_GeometryFromWkb', 'ST_GeomFromWkb'], 'VARCHAR', ['STRING'], 'ALWAYS_NULLABLE'],
        [['ST_ClosestPoint'], 'VARCHAR', ['VARCHAR','VARCHAR'], 'ALWAYS_NULLABLE'],
        [['ST_ClosestPoint'], 'VARCHAR', ['STRING','STRING'], 'ALWAYS_NULLABLE'],
        [['ST_DWithin'], 'BOOLEAN', ['VARCHAR','VARCHAR','DOUBLE'], 'ALWAYS_NULLABLE'],
        [['ST_DWithin'], 'BOOLEAN', ['STRING','STRING','DOUBLE'], 'ALWAYS_NULLABLE'],
        [['ST_Buffer'], 'VARCHAR', ['VARCHAR','DOUBLE'], 'ALWAYS_NULLABLE'],
        [['ST_Buffer'], 'VARCHAR', ['STRING','DOUBLE'], 'ALWAYS_NULLABLE'],
        [['ST_Dimension'], 'INT', ['VARCHAR'], 'ALWAYS_NULLABLE'],
        [['ST_Dimension'], 'INT', ['STRING'], 'ALWAYS_NULLABLE'],
        [['ST_IsEmpty'], 'BOOLEAN', ['VARCHAR'], 'ALWAYS_NULLABLE'],
        [['ST_IsEmpty'], 'BOOLEAN', ['STRING'], 'ALWAYS_NULLABLE'],
        [['ST_Length'], 'DOUBLE', ['VARCHAR'], 'ALWAYS_NULLABLE'],
        [['ST_Length'], 'DOUBLE', ['STRING'], 'ALWAYS_NULLABLE'],
        [['ST_IsClosed'], 'BOOLEAN', ['VARCHAR'], 'ALWAYS_NULLABLE'],
        [['ST_IsClosed'], 'BOOLEAN', ['STRING'], 'ALWAYS_NULLABLE'],
        [['ST_IsCollection'], 'BOOLEAN', ['VARCHAR'], 'ALWAYS_NULLABLE'],
        [['ST_IsCollection'], 'BOOLEAN', ['STRING'], 'ALWAYS_NULLABLE'],
        [['ST_IsRing'], 'BOOLEAN', ['VARCHAR'], 'ALWAYS_NULLABLE'],
        [['ST_IsRing'], 'BOOLEAN', ['STRING'], 'ALWAYS_NULLABLE'],
        [['ST_NumGeometries'], 'BIGINT', ['VARCHAR'], 'ALWAYS_NULLABLE'],
        [['ST_NumGeometries'], 'BIGINT', ['STRING'], 'ALWAYS_NULLABLE'],
        [['ST_NumPoints'], 'BIGINT', ['VARCHAR'], 'ALWAYS_NULLABLE'],
        [['ST_NumPoints'], 'BIGINT', ['STRING'], 'ALWAYS_NULLABLE'],
        [['St_GeometryType'], 'VARCHAR', ['VARCHAR'], 'ALWAYS_NULLABLE'],
        [['St_GeometryType'], 'VARCHAR', ['STRING'], 'ALWAYS_NULLABLE'],
        [['St_Centroid'], 'VARCHAR', ['VARCHAR'], 'ALWAYS_NULLABLE'],
        [['St_Centroid'], 'VARCHAR', ['STRING'], 'ALWAYS_NULLABLE'],

        [['ST_AsGeoJson'], 'VARCHAR', ['VARCHAR'], 'ALWAYS_NULLABLE'],
        [['ST_AsGeoJson'], 'VARCHAR', ['STRING'], 'ALWAYS_NULLABLE'],
        [['ST_GeometryFromGeoJson', 'ST_GeomFromGeoJson'], 'VARCHAR', ['VARCHAR'], 'ALWAYS_NULLABLE'],
        [['ST_GeometryFromGeoJson', 'ST_GeomFromGeoJson'], 'VARCHAR', ['STRING'], 'ALWAYS_NULLABLE'],
        [['St_Boundary'], 'VARCHAR', ['VARCHAR'], 'ALWAYS_NULLABLE'],
        [['St_Boundary'], 'VARCHAR', ['STRING'], 'ALWAYS_NULLABLE'],
